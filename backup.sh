...
MYIP=$(curl -sS ipv4.icanhazip.com)
NameUser=$(curl -sS https://raw.githubusercontent.com/VPN-EXECUTIVE/testi/xray/ip | grep $MYIP | awk '{print $2}')
...
Save_And_Exit () {
    ...
    git remote add origin https://github.com/VPN-EXECUTIVE/userbackup
    git push -f https://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@github.com/VPN-EXECUTIVE/userbackup.git &> /dev/null
}
...
link="https://raw.githubusercontent.com/VPN-EXECUTIVE/testi/xray/$NameUser/$NameUser.zip"
sleep 1

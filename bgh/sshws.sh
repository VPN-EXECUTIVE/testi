...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/VPN-EXECUTIVE/testi/xray/bgh/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/VPN-EXECUTIVE/testi/xray/bgh/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/VPN-EXECUTIVE/testi/xray/bgh/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/VPN-EXECUTIVE/testi/xray/bgh/proxy3.js"
...
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/VPN-EXECUTIVE/testi/xray/bgh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler && /usr/bin/ssh-wsenabler
